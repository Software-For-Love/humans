            ...
            <div class="feature-container">
                ...
                <div class="featured-contents">
                            ...
                            return (
                                <div class="featured-date">
                                    <div id="date-container">
                                        <h2 id="m2">{date}</h2>
                                        <button type="button" id="arrow-small"><img src={rightArrows} /></button>
                                    </div>
                                            ...
                                            objectData.map((person, index) => {
                                                ...
                                                return (
                                                    <div class="pic" key={index}>
                                                        <button class="person-btn"><img id="img" src={person.img} /></button>
                                                        ...
                                                        <div class="picdet">
                                                            ...
                                                            <div class="picdes">
                                                                ...
                                                                <p><button id="all_medias">
                                                                    <img src={insta} id="insta_pic" className="photo-for-mainpage" alt="Photo" />&nbsp;
                                                                    <img src={facebook} id="facebook_pic" className="photo-for-mainpage" alt="Photo" />
                                                                    <img src={twitter} id="twitter_pic" className="photo-for-mainpage" alt="Photo" />
                                                                    <img src={internet} id="internet_pic" className="photo-for-mainpage" alt="Photo" />
                                                                </button></p>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="arrow-container">
                        <button type="button" id="arrow"><img src={rightArrows} /></button>
                    </div>
